...
- [Scaphandre](https://github.com/hubblo-org/scaphandre), un logiciel de supervision de la consommation d'énergie des serveurs informatiques.
- [DCWatch](https://dcwatch.hubblo.org) un commun numérique et projet collaboratif de recherche pour identifier les datacenters et comptabiliser leur empreinte foncière et environnementale
- [DCFootprint](https://dcfootprint.org) un commun numérique et outil open-source pour l'évalution d'empreinte envioronnementale des datacenters


Je contribue également à plusieurs projets, notamment: [Boagent](https://github.com/boavizta/boagent), [BoaviztAPI](https://github.com/boavizta/boaviztapi), [windows-rapl-driver](https://github.com/hubblo-org/windows-rapl-driver).

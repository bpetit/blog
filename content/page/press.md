...
- [Pourquoi l'évaluation des impacts environnementaux exige des outils, des méthodes et des données libres ?, co-écrit avec David Ekchajzer sur le blog d'Hubblo](https://hubblo.org/fr/articles/20221130-open-source-evaluation/)

## 2018

### En français

- [Ansibled - DNS, proxy et terminaison TLS pour vos applications, blog de Wescale](https://blog.wescale.fr/ansibled-dns-proxy-et-terminaison-tls-pour-vos-applications)
- [Mininet: tester ses applications, dans un contexte réseau réaliste, sans susrcoût, blog de Wescale](https://blog.wescale.fr/mininet-tester-ses-applications-dans-un-contexte-reseau-realiste-sans-surcout-2)
- [Flannel: les réseaux de conteneurs par CoreOS, blog de Wescale](https://blog.wescale.fr/flannel-les-reseaux-de-conteneurs-par-coreos)
- [SDN: principes et fonctionnement, blog de Wescale](https://blog.wescale.fr/sdn-principes-et-fonctionnement)
- [Les réseaux d'overlay: principes et fonctionnement, blog de Wescale](https://blog.wescale.fr/les-reseaux-doverlay-principes-et-fonctionnement)

## 2017

### En français

- [Retour sur l'OpenStack Day France 2017, Blog de Wescale](https://blog.wescale.fr/retour-sur-lopenstack-day-france-2017)
